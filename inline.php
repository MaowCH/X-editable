...
<table border="1">
    <tr><td>ชื่อ</td><td>อายุ</td><td>เงินเเดือน</td><td>ตำแหน่ง</td></tr>
...
while($row = mysqli_fetch_array($result)){
   ...
   echo '<td><a  href="#" class="editPosition" data-type="select" data-name="position" data-pk="'.$row["id"].'" data-url="update.php" data-title="Enter username">'.$row["position"].'</a></td>';
    echo '</tr>';
